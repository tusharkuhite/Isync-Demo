...
<div class="d-flex gap-3 top-input-space">
        ...
        <div class="d-flex flex-wrap right-side-top">
            ...
            @if(isset($permission) && $permission != null && $permission->eWrite == "Yes")
            <div class="space">
                <a href="{{route('admin.role.add')}}" class="btn btn-primary">+ Add</a>
            </div>
            @endif
        </div>
    </div>
               ...
               <table class="table table-bordered">
                  <thead>
                     <tr>
                        ...
                        <th><input placeholder="Role" id="vRole" type="text" name="vRole" class="search form-control"></th>
...
<script type="text/javascript">
    ...
    function filter(vUniqueCode, vAction, vPages)
    {
        ...
        $.ajax({
           ...
           data: {vUniqueCode:vUniqueCode, vAction:vAction, pages:pages, vRole:vRole, vCode:vCode, eStatus_search:eStatus_search,eStatus:eStatus,eDeleted:eDeleted,eFeature_search:eFeature_search,},
