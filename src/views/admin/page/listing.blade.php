...
@else
    @section('title', 'Page Listing- '.$setting_info['COMPANY_NAME']['vValue'])
@endif
@section('content')
...
<div class="d-flex gap-3 top-input-space">
        ...
        <div class="d-flex flex-wrap right-side-top">
            ...
            <div class="space">
                    <a href="{{url('admin/page/add')}}" class="btn btn-primary">+ Add</a>
            </div>
            @endif
        </div>
    </div>
               ...
               <table class="table table-bordered">
                  <thead>
                     <tr>
                        ...
                        <th ><input placeholder="Page" id="vPage" type="text" name="vPage" class="search form-control"></th>
...
<script type="text/javascript">
    ...
    function filter(vUniqueCode, vAction, vPages)
    {
        ...
        setTimeout(function() {
        $.ajax({
           url: "{{url('admin/page/ajax_listing')}}",
           type: "POST",
           headers:{'X-CSRF-TOKEN':$('meta[name="csrf-token"]').attr('content')},
           data: {vUniqueCode:vUniqueCode,vAction:vAction,pages:pages,vPage:vPage,vSlug:vSlug,eStatus:eStatus,eStatus_search:eStatus_search,eDeleted:eDeleted},
