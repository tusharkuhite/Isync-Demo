...
class Paginator
{
    ...
    'next'=>' &raquo;',
    'prev' =>'&laquo;',
    'first' =>" <i class='fa-solid bx bx-left-arrow-alt'></i>",
    'last' =>"<i class='fa-solid bx bx-right-arrow-alt'></i>",
    'ipp' =>'Item per page'
    );
    ...
    public function paginate($selectedpagelimit="")
    {
        if(isset($_POST['current']))
        {
         ...
         if($selectedpagelimit > 10){
           
            $this->itemsPerPage =  $selectedpagelimit;
